...
globalkeys = awful.util.table.join(
    ...
    -- Bluetooth otp
    awful.key({ modkey, "Shift" }, "i", function () awful.util.spawn(otp) end),
...
run_once("urxvt -name DB16URxvt -e tmx work 1", "DB16URxvt.awesome")
